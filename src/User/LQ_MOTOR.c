...
void Ban_Motor(void)
{
    ...
    while(1)
    {duty += 100;
            if(duty > FTM_PRECISON/1.5)  //防止duty超
            {
                duty = FTM_PRECISON/1.5;break;
...
void M_Motor(void)
{
    ...
    while(1)
    {duty += 100;
            if(duty > FTM_PRECISON/2.0)  //防止duty超
            {
                duty = FTM_PRECISON/2.0;break;
...
void G_Motor(void)
{
    ...
    while(1)
    {duty += 100;
            if(duty > FTM_PRECISON/1.6)  //防止duty超
            {
                duty = FTM_PRECISON/1.6;break;
...
void D_Motor(void)
{
    ...
    while(1)
    {duty += 100;
            if(duty > FTM_PRECISON/1.1)  //防止duty超
            {
                duty = FTM_PRECISON/1.1;break;
